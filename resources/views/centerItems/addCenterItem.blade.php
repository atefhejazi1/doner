...
<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<form id="kt_ecommerce_settings_general_form" class="form" action="" method="post" role="form"> <input type="hidden" name="csrfmiddlewaretoken" value="Fr4qE8I49w5B9TYEs0mKqXbBa14ootMCmEYH0Y8781VBP5RjtoWRnjLZsus3rWb1">
                                    	...
                                    	<!--begin::Input group-->
														<div class="row fv-row mb-7">
															...
															<div class="col-md-9">
                                                                ...
                                                                <input type="text" name="type" maxlength="200" class="form-control form-control-solid" id="id_type">
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
