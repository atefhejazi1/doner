				...
				<div class="card card-flush">
					<div class="card-body">
						...
						<div class="row g-5 g-xl-10 mb-xl-10">
							<form id="kt_ecommerce_settings_general_form" class="form" action="{{url('expenditures/store')}}" method="post" role="form"> <input type="hidden" name="csrfmiddlewaretoken" value="2QhVcoV4KcGdjKwvSemZi40DwgEM5z8nJ3bcyel7JHwdZWpaTCW6fqA1OJ2r82xM">
								@csrf()
								<!--begin::Input group-->
