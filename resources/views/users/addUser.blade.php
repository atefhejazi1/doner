				...
				<div class="card card-flush">
					<div class="card-body">
						...
						<div class="row g-5 g-xl-10 mb-xl-10">
							<form id="kt_ecommerce_settings_general_form" class="form" action="{{ url('users/store') }}" method="post" role="form"> <input type="hidden" name="csrfmiddlewaretoken" value="GAJRM61b3m4qzRl7scQwaZvqbCvwzWtknND88Wre2RUqf3eMtAqD7l5Ot5TbCpSJ">
								@csrf()
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										...
										<input type="text" name="name" maxlength="200" class="form-control form-control-solid" id="id_username">
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
								...
								<div class="row fv-row mb-7 ">
									...
									<div class="col-md-9">
										...
										<label class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
											<label for="id_user_status_0"><input type="radio" name="roles" value="admin" id="id_user_status_0">
												Admin</label>
										</label>

										<label class="form-check form-check-custom form-check-solid form-check-success flex-shrink-0 me-6">
											<label for="id_user_status_1"><input type="radio" name="roles" value="user" id="id_user_status_1">
												User</label>
										</label>
