							...
							<table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_category_table">
								...
								<thead>
									...
									<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
										<th class="min-w-150px sorting" tabindex="0" aria-controls="kt_ecommerce_category_table" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 191.922px;">Name</th>
										<th class="min-w-150px sorting_disabled" rowspan="1" colspan="1" aria-label="Password " style="width: 197.359px;">Password </th>
										<th class="min-w-150px sorting_disabled" rowspan="1" colspan="1" aria-label="Type" style="width: 197.359px;">Type</th>
									...
									<tr class="odd">
										...
										<td>
											<div class="d-flex">
												...
												<div class="ms-5">
													<!--begin::Title-->
													<a href="" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">{{ $user->name }}</a>
													<!--end::Title-->
										...
										<td>
											<div class="d-flex">
												...
												<div class="ms-5">
													...
													<a href="" class=" text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">{{ $user->password }}</a>
										...
										<td>
											<div class="d-flex">
												...
												<div class="ms-5">
													...
													<a class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1 badge badge-light-success " data-kt-ecommerce-category-filter="category_name">{{ $user->user_status }}</a>
													<!--end::Title-->
