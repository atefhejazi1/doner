				...
				<div class="card card-flush">
					<div class="card-body">
						...
						<div class="row g-5 g-xl-10 mb-xl-10">
							<form id="kt_ecommerce_settings_general_form" class="form" action="" method="post" role="form"> <input type="hidden" name="csrfmiddlewaretoken" value="HScR7E7xbWk5O2pjljRKYd7jWIbgScaDo568tuxAara5ueiYmHrRVzHHebzVVFz2">
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										<!--begin::Input-->
										<input type="text" name="phone" value="+36" maxlength="17" class="form-control form-control-solid" id="id_phone">
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										<!--begin::Input-->
										<textarea name="address" cols="40" rows="10" class="form-control form-control-solid textarea" required="" id="id_address"> </textarea>
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
