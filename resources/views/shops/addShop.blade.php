							...
							<form id="kt_ecommerce_settings_general_form" class="form" action="" method="post" role="form"> <input type="hidden" name="csrfmiddlewaretoken" value="i0PObtfztVq7nBS0icNvgwKjtjRw2l9oZdJ5xjFCsqg73NLFjAnCdSkHLMfb5OyN">
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										...
										<input type="text" name="shop_name" maxlength="100" class="form-control form-control-solid" required="" id="id_shop_name">
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										...
										<input type="text" name="company_name" maxlength="200" class="form-control form-control-solid" id="id_company_name">
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										...
										<input type="text" name="company_address" maxlength="200" class="form-control form-control-solid" required="" id="id_company_address">
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										...
										<input type="text" name="tax_number" maxlength="200" class="form-control form-control-lg form-control-solid" required="" id="id_tax_number">
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-9">
										...
										<input type="text" name="shop_address" maxlength="200" class="form-control form-control-solid" required="" id="id_shop_address">
										<!--end::Input-->
									</div>
								</div>
								<!--end::Input group-->
