									...
									<tr class="odd">
										...
										<td>
											<div class="d-flex">
												...
												<div class="ms-5">
													<!--begin::Title-->
													<a href="" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">gaza</a>
													<!--end::Title-->
										...
										<td class="text-end">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<a href="/shop/update/1/" class="btn ink-reaction btn-floating-action btn-success w-125px">Edit</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="/shop/delete/1/" class="btn ink-reaction btn-floating-action btn-danger w-125px" onclick="return confirm('Biztos törölni szeretnéd !!??')">Delete</a>
												</div>
												<!--end::Menu item-->
											</div>
											<!--end::Menu-->
